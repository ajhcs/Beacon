...
fn validate_entity_refs(ir: &FresnelFirIR, errors: &mut Vec<ValidationError>) {
...
fn validate_protocol_actions(ir: &FresnelFirIR, errors: &mut Vec<ValidationError>) {
...
fn validate_protocol_refs(ir: &FresnelFirIR, errors: &mut Vec<ValidationError>) {
...
fn validate_protocol_structure(ir: &FresnelFirIR, errors: &mut Vec<ValidationError>) {
    for (proto_name, protocol) in &ir.protocols {
...
fn collect_refs(
    node: &ProtocolNode,
    from: &str,
    protocols: &std::collections::HashMap<String, fresnel_fir_ir::types::Protocol>,
