...
use beacon_ir::types::{ActionBinding, Bindings};
use beacon_sandbox::sandbox::{SandboxError, SandboxInstance, WasmVal};
...
/// The verification adapter — the ONLY interface between Beacon and the DUT.
///
...
impl VerificationAdapter {
    ...
    ///
    /// This is the forward direction: Beacon -> DUT.
